...
const Button = ({
    ...
    const variants = {
        ...
        outline: 'border border-slate-300 bg-transparent text-slate-700 hover:bg-slate-50 focus:ring-primary-500 dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-800',
